...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/alexb/mate17/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/alexb/mate17/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/alexb/mate17/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'alexb <alexb@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alexb/mate17/src/beginner_tutorials/${idir}'.  Ask the maintainer 'alexb <alexb@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alexb/mate17/devel/lib;/home/alexb/mate17/devel/lib;/opt/ros/indigo/lib)
